...
export const GUIDES: GuideData[] = [
  ...
  {
    id: 'gemini-product-prompts',
    title: 'תרשמו את זה — תקבלו את זה',
    description: '48 פקודות קצרות ל-Gemini שהופכות תמונת מוצר רגילה מהטלפון לצילום פרסומת מקצועי',
    summary: 'במקום לכתוב פרומפט ארוך בכל פעם — מעלים תמונת מוצר ל-Gemini וכותבים פקודה אחת קצרה. המדריך נותן לכם את כל 48 הפקודות מסודרות לפי קטגוריה: סגנון צילום, אפקטים, סביבה אמיתית, אריזה, יתרונות ותוכן לסושיאל. כולל 5 דוגמאות לפני-ואחרי ותהליך עבודה מוכן לקמפיין שלם.',
    image: '/guides/guide-gemini-product-prompts.png',
    href: '/guides/gemini-product-prompts',
    category: 'שיווק דיגיטלי',
    popular: false,
    isNew: true,
    date: '2026-09-20',
