...
export const GUIDES: GuideData[] = [
  {
    ...
    summary: 'אונבוקסינג, UGC, לפני ואחרי, טסטימוניאל, מאחורי הקלעים — כל אחד מהם בדרך כלל דורש הפקה נפרדת. כאן לקחתי תמונה אחת של מוצר והרצתי עליה 16 פקודות קצרות ב-Gemini. המדריך כולל את כל 16 הפקודות עם סרטון תוצאה לכל אחת, והמלצה באילו ארבעה להתחיל.',
    image: '/guides/guide-multi-ad-generator.png',
    href: '/guides/multi-ad-generator',
  ...
  {
    id: 'chatgpt-product-prompts',
    title: 'תרשמו את זה — תקבלו את זה',
    description: '48 פקודות קצרות ל-ChatGPT שהופכות תמונת מוצר רגילה מהטלפון לצילום פרסומת מקצועי',
    summary: 'במקום לכתוב פרומפט ארוך בכל פעם — מעלים תמונת מוצר ל-ChatGPT וכותבים פקודה אחת קצרה. המדריך נותן לכם את כל 48 הפקודות מסודרות לפי קטגוריה: סגנון צילום, אפקטים, סביבה אמיתית, אריזה, יתרונות ותוכן לסושיאל. כולל 5 דוגמאות לפני-ואחרי ותהליך עבודה מוכן לקמפיין שלם.',
    image: '/guides/guide-chatgpt-product-prompts.png',
    href: '/guides/chatgpt-product-prompts',
    category: 'שיווק דיגיטלי',
    popular: false,
    isNew: true,
    date: '2026-09-20',
  ...
  {
    id: 'chatgpt-coupon-finder',
    title: 'ככה ChatGPT מוצא לכם קוד קופון שבאמת עובד',
    description: 'שני פרומפטים שגורמים ל-ChatGPT למצוא כל קוד הנחה למוצר — ואז לבדוק אותם אחד-אחד בדפדפן',
    summary: 'כולנו מכירים את זה: מחפשים קוד קופון בגוגל, מקבלים שבעה קודים, ואף אחד לא עובד. המדריך הזה נותן שני פרומפטים — הראשון מוצא את כל הקודים הקיימים עם מקור לכל אחד, והשני שולח את ChatGPT לפתוח דפדפן ולבדוק כל קוד בדף התשלום בעצמו. כולל תרגום לעברית והסבר למה כל שורה בפרומפט חשובה.',
    image: '/guides/guide-chatgpt-coupon-finder.png',
    href: '/guides/chatgpt-coupon-finder',
    category: 'אוטומציות',
    popular: true,
    isNew: true,
    date: '2026-09-20',
