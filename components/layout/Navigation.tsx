...
export function Navigation() {
  ...
  return (
    <>
      ...
      <nav className="bg-white/90 backdrop-blur-md border-b border-gray-200/60 sticky top-0 z-50 hidden lg:block">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-8">
              ...
              <div className="relative group">
                <button className={`text-base font-medium hover:text-orci-cyan transition-colors flex items-center gap-1 ${pathname.startsWith('/guides') ? 'text-orci-cyan' : 'text-gray-700'}`}>
                  מדריכים
      ...
      {/* Mobile Top Bar - Minimal with logo only */}
      <nav className="bg-white/90 backdrop-blur-md border-b border-gray-200/60 sticky top-0 z-50 lg:hidden">
        <div className="max-w-7xl mx-auto px-6 py-4">
