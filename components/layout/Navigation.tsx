...
export function Navigation() {
  ...
  return (
    <>
      ...
      <nav className="sticky top-0 z-50 hidden lg:block" style={{background: 'rgba(13,13,26,0.85)', backdropFilter: 'blur(16px)', borderBottom: '1px solid rgba(0,255,209,0.12)'}}>
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            {/* Logo */}
            <Link href="/" className="flex items-center">
              <div className="text-2xl font-black tracking-tight">
                <span style={{color:'#ffffff'}}>Orci</span><span style={{background:'linear-gradient(135deg,#00FFD1,#534AB7)',WebkitBackgroundClip:'text',WebkitTextFillColor:'transparent'}}>AI</span>
              </div>
            </Link>
            ...
            <div className="flex items-center gap-8">
              ...
              <a href="https://wa.me/972542599107" target="_blank" rel="noopener noreferrer" className="px-5 py-2 bg-orci-cyan text-slate-900 rounded-full font-bold hover:opacity-90 transition-all flex items-center gap-2" style={{boxShadow:'0 0 16px rgba(0,255,209,0.35)'}}>
      ...
      {/* Mobile Top Bar - Dark */}
      <nav className="sticky top-0 z-50 lg:hidden" style={{background: 'rgba(13,13,26,0.85)', backdropFilter: 'blur(16px)', borderBottom: '1px solid rgba(0,255,209,0.12)'}}>
        <div className="max-w-7xl mx-auto px-6 py-4">
