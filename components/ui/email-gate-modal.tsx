  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      if (res.ok) {
        ...
        // If already subscribed, still unlock
                  ...
                  <>
                    ...
                    <div className="flex justify-center gap-4 mb-6 text-xs text-slate-400">
                      <span className="flex items-center gap-1">
                        <span className="text-orci-cyan">✓</span> גישה לכל המדריכים
                      </span>
                      <span className="flex items-center gap-1">
                        <span className="text-orci-cyan">✓</span> עדכונים שבועיים
                      </span>
                      <span className="flex items-center gap-1">
                        <span className="text-orci-cyan">✓</span> בחינם לגמרי
                      </span>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-3">
                      <div className="relative">
                        <Mail
                          className="absolute top-1/2 -translate-y-1/2 right-3 w-4 h-4 text-slate-500"
                        />
                        <input
                          type="email"
                          value={email}
                          ...
                          onFocus={(e) => { e.target.style.borderColor = 'rgba(0,209,255,0.6)'; e.target.style.boxShadow = '0 0 0 3px rgba(0,209,255,0.1)'; }}
                          onBlur={(e) => { e.target.style.borderColor = 'rgba(0,209,255,0.2)'; e.target.style.boxShadow = 'none'; }}
                        />
                      </div>
