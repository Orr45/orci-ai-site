...
const PRIVACY = [
  {
    num: '01',
    title: 'מה אנו אוספים',
    body: 'השירות אוסף מינימום: כתובת אימייל (אם בחרת לקבל את התכנים), וכתובת IP לאבטחה בלבד. אין איסוף פרטים מזהים נוספים, ואין פרופיילינג.',
  },
  {
    num: '02',
    title: 'שימוש במידע',
  ...
  },
  {
    num: '06',
    title: 'זכויות המשתמש',
    body: 'ניתן לבקש מחיקה, תיקון, או העברה של הנתונים האישיים שלכם בכל עת. פנו אלינו דרך WhatsApp 054-259-9107 או המייל: orciai45@gmail.com — נענה תוך 14 ימי עסקים.',
  },
  {
    num: '07',
    title: 'אבטחה',
  ...
  },
  {
    num: '08',
    title: 'יצירת קשר',
    body: 'לשאלות בנושא פרטיות: WhatsApp 054-259-9107 | מייל: orciai45@gmail.com',
  },
];
