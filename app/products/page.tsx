  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="cap-section cap-section-teal">
        <div className="max-w-7xl mx-auto px-6">
          <div className="cap-card text-center">
            ...
            <a
              href={PRODUCT_INFO.ctaLink}
              target="_blank"
              rel="noopener noreferrer"
              className="cap-btn cap-btn-primary mt-8 inline-flex"
            >
      ...
      <section className="cap-section cap-section-white">
        <div className="max-w-7xl mx-auto px-6">
          <h2 className="text-2xl md:text-3xl font-bold mb-8 text-center">מה כלול בחבילה?</h2>

          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {PRODUCT_FEATURES.map((feature) => (
              <div
                key={feature.id}
                className={`cap-card-small min-h-[200px] flex flex-col justify-center ${
                  feature.highlighted ? 'border-2 border-orci-cyan' : ''
                }`}
              >
                ...
                {feature.highlighted && (
                  <div className="mt-3 text-center">
                    <span className="text-xs font-bold text-orci-cyan bg-orci-cyan/10 px-3 py-1 rounded-full">
                      מומלץ
                    </span>
                  </div>
                )}
        ...
        <div className="max-w-4xl mx-auto px-6">
          <div className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-2xl p-8 md:p-12 text-center shadow-2xl">
            ...
            <p className="text-gray-300 mb-6 text-lg">
              שלחו לי הודעה ונתחיל לבנות את הנוכחות הדיגיטלית שלכם - אני כאן כדי לעזור לכם להצליח
            </p>
            <a
